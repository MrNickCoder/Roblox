...
local function credits()
    ...
    Developers:Cheat("Label","📝 Modified by: NickCoder")   
...
function autoload()
    pcall(function()
        ...
        if exec == "Synapse X" and Settings.AutoLoadScript then
            syn.queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/MrNickCoder/Roblox/main/forks/AnimeAdventures_v2__Beta.lua'))()")
        elseif exec ~= "Synapse X" and Settings.AutoLoadScript then
            queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/MrNickCoder/Roblox/main/forks/AnimeAdventures_v2__Beta.lua'))()")
        elseif exec ~= "Synapse X" and Settings.AutoLoadScript then
            syn.queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/MrNickCoder/Roblox/main/forks/AnimeAdventures_v2__Beta.lua'))()")
        end
    end)
        ...
        coroutine.resume(coroutine.create(function()
            ...
            repeat
                ...
                for _,v in pairs(game:GetService("Workspace")._UNITS:GetChildren()) do
                    if table.find(UnitsE,v.Name) and v:FindFirstChild("_stats"):FindFirstChild("player").Value == LocalPlayer and not table.find(erwin1, v) then
    ...
    if Settings.EnableBuffwendyLoop and game.PlaceId ~= 8304191830 then
        coroutine.resume(coroutine.create(function()
            ...
            repeat
                ...
                for _,v in pairs(game:GetService("Workspace")._UNITS:GetChildren()) do
                    if table.find(UnitsW,v.Name) and v:FindFirstChild("_stats"):FindFirstChild("player").Value == LocalPlayer and not table.find(wendy1, v) then
    ...
    if Settings.EnableBuffleafaLoop and game.PlaceId ~= 8304191830 then
        coroutine.resume(coroutine.create(function()
            ...
            repeat
                ...
                for _,v in pairs(game:GetService("Workspace")._UNITS:GetChildren()) do
                    if table.find(UnitsL,v.Name) and v:FindFirstChild("_stats"):FindFirstChild("player").Value == LocalPlayer and not table.find(leafa1, v) then
